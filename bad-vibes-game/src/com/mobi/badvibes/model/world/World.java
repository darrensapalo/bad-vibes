...
public abstract class World
{
    ...
    /**
     * This defines the line where the game allows the players to be dragged.
     */
    public static final int SAFE_AREA_START  = 120;
    ...
    /**
     * This method returns the center position of a random cell from the mini
     * grid of the platform. This means that each cell of the platform grid is
    ...
    /**
     * This method returns the center position of a specified cell from the mini
     * grid of the platform. This means that each cell of the platform grid is
     * subdivided into four parts.
     * 
     * @param gridx
    ...
    /**
     * This method returns the center position of a specified cell from the grid
     * of the platform.
     * 
     * @param gridx
     *            the x axis
