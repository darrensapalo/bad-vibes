...
/**
 * This facade class handles the loading of level design and 
 * preparation of the game itself.
 * @author Darren
 *
 */
public class GameMaster {
	/**
	 * This method handles the calling of the level design 
	 * depending on the level of the user.
	 * 
	 *  It also switches to the pre-game screen to inform
	 *  the user how to play the said level.
	 *  @see PreGameScreen
	 */
