...
public class DragGameplay extends Gameplay
{
    ...
    /**
     * This code creates a tween for the person to be picked up. This animation
     * lasts for a short 50ms.
     * 
     * @param person
     *            - the person to be picked up
     */
    ...
    /**
     * This prepares the person to be picked up. (1) recognizes the touch
     * pointer used to pick up the person, (2) removes any tweens the person
     * currently has, (3) removes any logic it is currently running, (4) makes
     * the art of the person look picked up, (5) sets the offset of the person.
     * 
     * @param person
     *            - the person to be initialized
     * @param pointer
     *            - the touch pointer id
     * @param p
     *            - the point where the person was clicked
     */
    ...
    /**
     * This method prepares the falling tween for the person. After the tween is
     * finished, (1) the person's touch reference, state, and press start point
     * is reset, (2) the logic is replaced depending on the previous logic, (3)
     * and the art of the person is set to idle
     * 
     * @param person
     *            - the person to initialize falling
     */
    ...
    /**
     * This prepares the person to fall. It (1) finds out which cell you are
     * planning to drop the person, (2) sets the person's position there, (3)
     * and makes the person's art look like he is falling.
     * 
     * @param person
     *            - the person to fall down
     * @param screenX
     *            - the press event's x position
     * @param screenY
     *            - the press event's y position
     */
    ...
    /**
     * This finds out which person is being dragged, and updates that persons'
     * cell position accordingly.
     */
    @Override
